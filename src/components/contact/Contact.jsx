...
function Contact() {
  ...
  return (
    <motion.div className='contact' ref={ref} initial="initial" whileInView="animate" variants={variants}>
      <motion.div className="textContainer" variants={variants}>
            <motion.h1>Let's Get In Touch</motion.h1>
            <motion.div className="item" variants={variants}>
                <motion.h2>Mail</motion.h2>
                <motion.span>sankalp20tiwari@gmail.com</motion.span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <motion.h2>Phone</motion.h2>
                <motion.span>+91 1234567890</motion.span>
            </motion.div>
            <motion.div className="item" variants={variants}>
      ...
      <motion.div className="phoneSvg" initial={{opacity:1}} whileInView={{opacity:0}} transition={{delay:3,duration:1}}>
        ...
        <motion.form ref={formRef} onSubmit={sendEmail} initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:4,duration:1}}>
            ...
            <motion.input type="email"  required placeholder='Email'  name ="email"/>
            <motion.textarea rows="8" placeholder='Message' name="message"></motion.textarea>
            <motion.button>Send</motion.button>
            {error && "Error"}
            {success && "Success"}
        </motion.form>
      </motion.div>
